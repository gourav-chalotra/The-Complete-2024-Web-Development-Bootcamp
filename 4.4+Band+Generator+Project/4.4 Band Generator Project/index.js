...
app.get("/", (req, res) => {
  console.log("Hello");
  realname = "Welcome to the Band Generator 🤟";
  res.render("index.ejs", { realname: realname });
  //Step 1 - Make the get route work and render the index.ejs file.
});

app.post("/submit", (req, res) => {
  console.log(Math.floor(Math.random() * (adj.length - 0) + 0));
  let firstName = adj[Math.floor(Math.random() * (adj.length - 0) + 0)];
  let lastName = noun[Math.floor(Math.random() * (noun.length - 0) + 0)];
